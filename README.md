...
Requirements in the consuming project: React 19, Tailwind CSS v4, and the `@/*` path alias. PRO items can depend on free components, and the CLI pulls those from this public repo automatically.
