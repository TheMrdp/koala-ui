// Tailwind v4 default color palette, extracted verbatim from
// node_modules/tailwindcss/theme.css. These are LITERAL values, theme-blind,
// authored in oklch. Kept as a data table so the Colors page can render the full
// 22-family x 11-shade grid; `values` aligns index-for-index with `SHADES`.
export const SHADES = [50, 100, 200, 300, 400, 500, 600, 700, 800, 900, 950] as const

export const TAILWIND_PALETTE: { name: string; values: string[] }[] = [
  { name: "red", values: [
