  ...
  <InputRoot disabled>
    <InputField id="disabled" placeholder="Disabled" />
      ...
      <DocSection title="API reference">
        <p className="mt-4 text-pretty text-muted-foreground">
          Input is a compound component - each part is a named export so they
          work across Server Component boundaries (no dot-notation).
        </p>
        <div className="mt-4 space-y-3 text-sm text-muted-foreground">
          <div>
            <code className="text-foreground">InputRoot</code> - wrapper{" "}
            <code>div</code>. Props: <code>size</code> (<code>sm</code> /{" "}
            <code>md</code> / <code>lg</code>), <code>hasError</code>,{" "}
            <code>disabled</code>. Provides context to all child parts.
          </div>
          <div>
            <code className="text-foreground">InputField</code> - the native{" "}
            <code>input</code>. Forwards all{" "}
            <code>{"<input>"}</code> props; reads <code>disabled</code> and{" "}
            <code>hasError</code> from context if not set locally.
          </div>
          <div>
            <code className="text-foreground">InputLabel</code> - a{" "}
          ...
          <div>
            <code className="text-foreground">InputHint</code> - helper{" "}
            <code>p</code> below the control. Set <code>hasError</code> to match{" "}
            <code>InputRoot</code> for the destructive tone; wire its{" "}
            <code>id</code> to the field's <code>aria-describedby</code>.
          </div>
          <div>
            <code className="text-foreground">InputPrefix</code> /{" "}
            <code className="text-foreground">InputSuffix</code> - decorative{" "}
            <code>span</code> slots for icons. Rendered{" "}
            <code>aria-hidden</code>.
          </div>
          <div>
            <code className="text-foreground">InputPrefixLabel</code> - fixed
            text segment flush with the left border. Uses negative margin + root{" "}
            <code>overflow-hidden</code> to sit inside the rounded corner.
          </div>
          <div>
            <code className="text-foreground">InputSuffixButton</code> - ghost{" "}
            <code>button</code> on the right. Always pass{" "}
            <code>aria-label</code>.
          </div>
          <div>
            <code className="text-foreground">PasswordInput</code> - convenience
            wrapper. Additional props: <code>rootClassName</code>,{" "}
            <code>size</code>, <code>hasError</code>. All other props go to the
            underlying <code>InputField</code>.
          </div>
          <div>
            <code className="text-foreground">NumberInput</code> - stepper
            wrapper. Props: <code>value</code>/<code>defaultValue</code> (
            <code>number | null</code>), <code>onValueChange</code>,{" "}
            <code>min</code>, <code>max</code>, <code>step</code>,{" "}
            <code>layout</code> (<code>{'"stacked"'}</code> /{" "}
            <code>{'"inline"'}</code>), plus <code>size</code>,{" "}
            <code>hasError</code>, <code>static</code>, <code>rootClassName</code>.
          </div>
          <div>
            <code className="text-foreground">PhoneInput</code> - country picker +
            national number. Props: <code>country</code>/
            <code>defaultCountry</code> (ISO2), <code>onCountryChange</code>,{" "}
            <code>value</code>/<code>defaultValue</code>,{" "}
            <code>onValueChange</code>, and <code>onChange</code> with a{" "}
            <code>{"{ country, dialCode, nationalNumber, e164 }"}</code> payload,
            plus <code>size</code>, <code>hasError</code>,{" "}
